...
//Explained https://raytracing.github.io/books/RayTracingInOneWeekend.html#diffusematerials and in the following chapters

struct hit_record;

#define RANDVEC3 vec3(curand_uniform(local_rand_state),curand_uniform(local_rand_state),curand_uniform(local_rand_state))

static __device__ vec3 random_in_unit_sphere(curandState* local_rand_state) {
	vec3 p;
	do {
